	...
	<div class="container content">
		<div class="row">
				...
				<ul class="nav">
					 <li><a href="${pageContext.request.contextPath}/market/home"><span class="glyphicon glyphicon-home"></span> 返回主页</a></li>
 				     ...
 				     <li><a href="${pageContext.request.contextPath}/market/setPwd.jsp"><span class="glyphicon glyphicon-edit"></span> 修改密码</a></li>
  				     <li><a class="active" href="${pageContext.request.contextPath}/market/editEmailPage"><span class="glyphicon glyphicon-envelope"></span> 绑定邮箱</a></li>
			...
			<div class="col-sm-9 right-part setEmail">
				<form class="form-horizontal" action="${pageContext.request.contextPath}/market/editEmail" method="post">
