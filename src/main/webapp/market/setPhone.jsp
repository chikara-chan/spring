			...
			<div class="col-sm-3 left-part">
				<ul class="nav">
 				     ...
 				     <li><a href="${pageContext.request.contextPath}/market/setPwd.jsp"><span class="glyphicon glyphicon-edit"></span> 修改密码</a></li>
  				     ...
  				     <li><a class="active" href="${pageContext.request.contextPath}/market/editPhonePage"><span class="glyphicon glyphicon-phone"></span> 绑定手机</a></li>
				</ul>
				<div class="blank"></div>
			</div>
			<div class="col-sm-9 right-part setEmail">
				<form class="form-horizontal" action="${pageContext.request.contextPath}/market/editPhone" method="post">
