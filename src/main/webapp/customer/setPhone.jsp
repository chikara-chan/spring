	...
	<div class="container content">
		<div class="row">
			<div class="col-sm-3 left-part">
				<ul class="nav">
 				     ...
 				     <li><a href="${pageContext.request.contextPath}/customer/setPwd.jsp"><span class="glyphicon glyphicon-edit"></span> 修改密码</a></li>
  				     ...
  				     <li><a class="active" href="${pageContext.request.contextPath}/customer/editPhonePage"><span class="glyphicon glyphicon-phone"></span> 绑定手机</a></li>
			...
			<div class="col-sm-9 right-part setEmail">
				<form class="form-horizontal" action="${pageContext.request.contextPath}/customer/editPhone" method="post">
					<c:if test="${!empty phone}">
						<div class="form-group">
							<label for="inputEmail1" class="col-sm-2 control-label">旧手机</label>
							<div class="col-sm-5">
								<input type="tel" name="oldPhone" class="form-control" id="inputEmail1" >
							</div>
						</div>
					</c:if>
					<div class="form-group">
						<label for="inputEmail2" class="col-sm-2 control-label">新手机</label>
						<div class="col-sm-5">
							<input type="tel" name="newPhone" class="form-control" id="inputEmail2" >
						</div>
					</div>	
					<div class="form-group">
